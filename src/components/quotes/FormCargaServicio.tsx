  ...
  return (
    <label className="flex items-center gap-2 cursor-pointer select-none">
      <button
        ...
        className={`w-8 h-4.5 rounded-full transition-colors relative shrink-0 ${valor ? 'bg-primario' : 'bg-gray-200'}`}
        style={{ height: 18 }}
      >
...
function BloqueBultos({ carga, onCambio }: {
  ...
  return (
    <div>
      ...
      <button type="button"
        className="mt-1.5 flex items-center gap-1 text-[10px] font-bold text-primario hover:text-primario-hover"
    ...
    <div className="border-t border-gray-100 pt-3">
      ...
      {abierto && (
        <div className="mt-2 space-y-1.5">
          ...
          <button type="button"
            className="flex items-center gap-1 text-[10px] font-bold text-primario hover:text-primario-hover"
    ...
    <div className="border border-gray-200 rounded-xl p-4 space-y-4 bg-white">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="text-[11px] font-bold text-primario uppercase tracking-widest">
              ...
              {(['fcl', 'lcl'] as const).map(t => (
                <button key={t} type="button"
                  ...
                  className={`px-3 py-1 text-[10px] font-bold uppercase transition-colors ${
                    carga.tipo === t ? 'bg-primario text-white' : 'bg-white text-gray-500 hover:bg-gray-50'
                  }`}>
