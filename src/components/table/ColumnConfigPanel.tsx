  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragging ? 'bg-primario/5' : 'hover:bg-gray-50'}
      `}
    >
      {/* Drag handle */}
      {!col.pinned ? (
      ...
      <button
        ...
        className={`shrink-0 ${col.pinned ? 'text-gray-300 cursor-not-allowed' : isVisible ? 'text-primario hover:text-primario-hover' : 'text-gray-300 hover:text-gray-500'}`}
  ...
  return (
    <div className="relative">
      <button
        ...
        className={`p-1.5 rounded transition-colors border ${open ? 'bg-primario/5 border-primario/30 text-primario' : 'bg-white border-gray-200 text-gray-400 hover:text-gray-600 hover:bg-gray-50'}`}
